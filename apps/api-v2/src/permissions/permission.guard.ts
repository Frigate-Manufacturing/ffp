...
export class PermissionGuard implements CanActivate {
    ...
    async canActivate(context: ExecutionContext): Promise<boolean> {
        const requiredPermissions = this.reflector.getAllAndOverride<string[]>(MetaNames.permissionsMetaKey, [
            context.getHandler(),
            context.getClass()
        ]);
        ...
        const user = req.user as { id: string, userId: string, role: string } | undefined;
