...
create index general_materials_category_idx on general_materials (category);
create index general_materials_category_stock_idx on general_materials (category, stock_material);
